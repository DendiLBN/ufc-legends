...
export default function LegendaryCard({ name, image, className = "" }: LegendaryCardProps) {
  return (
    <motion.div 
      whileHover={{ 
        scale: 1.02,
    ...
    >
      <motion.div 
        className="absolute -inset-[1px] bg-gradient-to-br from-amber-600 via-yellow-500 to-amber-700 rounded-xl opacity-75 group-hover:opacity-100 blur-lg transition-opacity"
      />
      <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-4 rounded-xl relative">
        ...
        <div className="space-y-1">
          <p className="font-oswald text-lg bg-gradient-to-r from-amber-500 to-yellow-400 bg-clip-text text-transparent">
            {name}
          </p>
        </div>
      </div>
