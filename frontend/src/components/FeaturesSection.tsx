    ...
    >
      <div>
        ...
        <p className="text-xl text-zinc-300 mb-8">
          Collect digital cards featuring legendary UFC fighters from past and present. Train them, upgrade their skills, and create the most powerful roster in the game.
        </p>
